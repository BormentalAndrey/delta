...
public class ApplicationPreferencesActivity extends PassphraseRequiredActionBarActivity
  ...
  private static final String PREFERENCE_CATEGORY_APPEARANCE =
      "preference_category_appearance";
  private static final String PREFERENCE_CATEGORY_CHATS = "preference_category_chats";
  private static final String PREFERENCE_CATEGORY_MULTIDEVICE =
      "preference_category_multidevice";
  private static final String PREFERENCE_CATEGORY_ADVANCED =
      "preference_category_advanced";
  private static final String PREFERENCE_CATEGORY_CONNECTIVITY =
      "preference_category_connectivity";
  private static final String PREFERENCE_CATEGORY_DONATE =
      "preference_category_donate";
  private static final String PREFERENCE_CATEGORY_HELP =
  ...
  public static class ApplicationPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
      ...
      this.findPreference(PREFERENCE_CATEGORY_APPEARANCE)
          .setOnPreferenceClickListener(
              new CategoryClickListener(PREFERENCE_CATEGORY_APPEARANCE));

      this.findPreference(PREFERENCE_CATEGORY_CHATS)
          .setOnPreferenceClickListener(
              new CategoryClickListener(PREFERENCE_CATEGORY_CHATS));

      this.findPreference(PREFERENCE_CATEGORY_MULTIDEVICE)
          .setOnPreferenceClickListener(
              new CategoryClickListener(PREFERENCE_CATEGORY_MULTIDEVICE));

      this.findPreference(PREFERENCE_CATEGORY_ADVANCED)
          .setOnPreferenceClickListener(
              new CategoryClickListener(PREFERENCE_CATEGORY_ADVANCED));

      this.findPreference(PREFERENCE_CATEGORY_DONATE)
          .setOnPreferenceClickListener(
              new CategoryClickListener(PREFERENCE_CATEGORY_DONATE));

      this.findPreference(PREFERENCE_CATEGORY_HELP)
          .setOnPreferenceClickListener(
              new CategoryClickListener(PREFERENCE_CATEGORY_HELP));
    ...
    public void onResume() {
      ...
      if (((ApplicationPreferencesActivity) getActivity())
    ...
    private void setCategorySummaries() {
      ...
      ((ProfilePreference) this.findPreference(PREFERENCE_CATEGORY_PROFILE))
          .refresh();

      this.findPreference(PREFERENCE_CATEGORY_NOTIFICATIONS)
          .setSummary(
              NotificationsPreferenceFragment.getSummary(getActivity()));

      this.findPreference(PREFERENCE_CATEGORY_APPEARANCE)
          .setSummary(
              AppearancePreferenceFragment.getSummary(getActivity()));

      this.findPreference(PREFERENCE_CATEGORY_CHATS)
          .setSummary(
              ChatsPreferenceFragment.getSummary(getActivity()));
      ...
      this.findPreference(PREFERENCE_CATEGORY_HELP)
          .setSummary(
              AdvancedPreferenceFragment.getVersion(getActivity()));
    }

    private class CategoryClickListener
      ...
      public boolean onPreferenceClick(Preference preference) {
        ...
        switch (category) {
                  ...
                  .setPositiveButton(
                      ...
                      (dialog, which) ->
                          getActivity().startActivity(
                              Permissions.getApplicationSettingsIntent(
                                  getActivity())))
          ...
          case PREFERENCE_CATEGORY_CONNECTIVITY:
            ...
            startActivity(
                new Intent(getActivity(), ConnectivityActivity.class));
          ...
          case PREFERENCE_CATEGORY_HELP:
            ...
            startActivity(
                new Intent(getActivity(), LocalHelpActivity.class));
    ...
    private class ProfileClickListener
        implements Preference.OnPreferenceClickListener {
